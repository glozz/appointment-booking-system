...
/// <summary>
/// Account controller using JWT API authentication (no direct database access)
/// </summary>
public class AccountController : Controller
{
    ...
    public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("User {Email} logged in via JWT API", model.Email);
    ...
    public async Task<IActionResult> Register(RegisterViewModel model)
    {
        ...
        try
        {
            ...
            _logger.LogInformation("User {Email} registered via JWT API", model.Email);
